...
- **Heterogeneous Graph Modeling**: 논문, 특허, 뉴스 등 서로 다른 속성의 데이터를 **Graph Data Structure**로 구조화하여 정보 간의 위계와 관계를 정의합니다.
- **Bridge Score Algorithm**: 도메인 간 유사도를 계산하기 위해 **Cosine Similarity**와 자체 개발한 **Heuristic** 가중치 로직을 결합, 지식 간의 최단 연결 경로를 탐색합니다.
